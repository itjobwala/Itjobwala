    ...
    >
      ...
      <div className="flex-1 min-w-0">
        <div className="flex items-center justify-between gap-2">
          <span className={`text-sm truncate ${hasUnread ? 'font-extrabold text-heading' : 'font-semibold text-body'}`}>
            {party?.name ?? 'Unknown'}
          </span>
        ...
        <div className="flex items-center justify-between gap-2 mt-0.5">
          <span className={`text-caption truncate ${hasUnread ? 'text-body font-medium' : 'text-subtle'}`}>
