  ...
  return (
    <div>
      ...
      <div className="bg-surface rounded-2xl border border-token shadow-sm p-2 flex flex-col sm:hidden gap-2">
        ...
        <button
          onClick={onSearch}
          className="bg-primary text-white text-lg font-bold rounded-xl px-6 py-3 hover:brightness-110 focus:outline-none focus:ring-2 focus:ring-primary/40 focus:ring-offset-2 transition-all w-full cursor-pointer"
        >
          Search
        </button>
      </div>
      ...
      <div className="hidden sm:flex bg-surface rounded-xl border border-token-mid shadow-[0_2px_8px_rgba(0,0,0,0.02)] p-1 items-center focus-within:border-primary/50 focus-within:ring-4 focus-within:ring-primary/10 transition-all duration-200">
        ...
        <button
          onClick={onSearch}
          className="bg-primary text-white text-base font-bold px-6 py-2 rounded-lg hover:brightness-110 focus:outline-none focus:ring-2 focus:ring-primary/40 focus:ring-offset-2 transition-[filter,box-shadow] shrink-0 flex items-center ml-1 cursor-pointer"
        >
          Search
        </button>
      </div>
