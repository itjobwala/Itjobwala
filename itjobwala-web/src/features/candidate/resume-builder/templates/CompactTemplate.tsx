...
const S = StyleSheet.create({
  ...
  jobTitle:      { fontSize: 10, color: '#4b5563', marginBottom: 5 },
  contactRow:    { flexDirection: 'row', flexWrap: 'wrap', marginBottom: 2 },
  contactItem:   { fontSize: 8.5, color: '#4b5563', marginRight: 14, marginBottom: 2 },
  divider:       { borderBottomWidth: 1.5, borderBottomColor: '#111827', marginBottom: 10, marginTop: 6 },
  sectionTitle:  { fontFamily: 'Helvetica-Bold', fontSize: 9, color: '#111827', textTransform: 'uppercase', letterSpacing: 1.2, marginBottom: 5, marginTop: 9, paddingBottom: 2, borderBottomWidth: 0.75, borderBottomColor: '#9ca3af' },
