    ...
    >
      <div className="bg-surface rounded-2xl max-w-md w-full shadow-2xl">
        ...
        <div className="flex items-center justify-between p-6 border-b border-token">
          <div>
            <h2 id="cert-upload-title" className="text-lg font-extrabold text-heading">Upload Certificate</h2>
            <p className="text-caption text-muted mt-1">{certificationName}</p>
          </div>
          <button
            onClick={onClose}
            disabled={isUploading}
            aria-label="Close"
            className="text-subtle hover:text-muted disabled:opacity-50 transition-colors shrink-0"
          >
