  ...
  return (
    <Card padding="none" className="p-6 sm:p-8" overflow>
      <div className="flex items-center justify-between mb-4">
        <h2 className="text-lg font-extrabold text-heading" style={{ letterSpacing: '-0.3px' }}>About</h2>
        {about ? (
          <Button
            variant="ghost"
            size="sm"
      ...
      {about ? (
        <p className="text-base text-body-secondary leading-[1.8]">{about}</p>
      ) : (
        <button
          onClick={onEdit}
        ...
        >
          ...
          <span className="text-sm font-semibold">Add a professional summary</span>
        </button>
      )}
    </Card>
  );
