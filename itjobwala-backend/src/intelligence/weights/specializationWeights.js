 ...
 *
 * Base weights (from scoreCalculator.js, sum = 100):
 *   automation_testing: 25 | api_testing: 20 | framework_expertise: 15
 *   qa_experience: 15      | performance_testing: 10 | certifications: 5
 *   bug_tracking: 5        | ci_cd_readiness: 5
 *
 * Each map redistributes these 100 points to reflect what recruiters
 * actually prioritize for that specialization.
 */
